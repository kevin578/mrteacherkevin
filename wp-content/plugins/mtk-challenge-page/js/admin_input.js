...
var check_input = ['<input type = "text" class = "check_input_box" placeholder="Skill to have completed">\
...
function add_check_input() {
	check_input.push('<input type = "text" class = "check_input_box" placeholder="Skill to have completed">');
	render_check_input();
}
